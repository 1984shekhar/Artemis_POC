...
ARTEMIS_HOME='/home/chandrashekhar/Development/AMQ_RH/amq-broker-7.7.0'
ARTEMIS_INSTANCE='/home/chandrashekhar/Development/AMQ_RH/AMQ_INSTANCE_770/brokerLdap'
ARTEMIS_DATA_DIR='/home/chandrashekhar/Development/AMQ_RH/AMQ_INSTANCE_770/brokerLdap/data'
ARTEMIS_OOME_DUMP='/home/chandrashekhar/Development/AMQ_RH/AMQ_INSTANCE_770/brokerLdap/log/oom_dump.hprof'

# The logging config will need an URI
# this will be encoded in case you use spaces or special characters
# on your directory structure
ARTEMIS_INSTANCE_URI='file:/home/chandrashekhar/Development/AMQ_RH/AMQ_INSTANCE_770/brokerLdap/'
ARTEMIS_INSTANCE_ETC_URI='file:/home/chandrashekhar/Development/AMQ_RH/AMQ_INSTANCE_770/brokerLdap/etc/'
...
# Java Opts
if [ -z "$JAVA_ARGS" ]; then
    JAVA_ARGS=" -XX:+PrintClassHistogram -XX:+UseG1GC -Xms512M -Xmx2G -Dhawtio.realm=activemq  -Dhawtio.offline=true -Dhawtio.role=user -Dhawtio.rolePrincipalClasses=org.apache.activemq.artemis.spi.core.security.jaas.RolePrincipal -Djolokia.policyLocation=${ARTEMIS_INSTANCE_ETC_URI}jolokia-access.xml -Djon.id=amq"
fi
#
