...
System.out.println("servicename: "+config.getServiceName());
System.out.println("servicePort: "+config.getServicePort());
    	    String remoteURI = String.format("amqp://%s:%s", config.getServiceName(), config.getServicePort());
